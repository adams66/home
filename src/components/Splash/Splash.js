...
function Splash() {
    ...
    return ( 
     <div className="splash" style={{position:"fixed", left: 0, top:0,width: "100%",height: "100%",zIndex:"999",display:"none",justifyContent:"center", alignItems: "center",background:"#170e67"}}>
        						<svg width="200px" xmlns="http://www.w3.org/2000/svg" viewBox="4 2 468 231">
							<path
